const signals = [
  ...
  { value: "Owned", label: "by ANTIKRA", detail: "built and operated" },
  { value: "Uganda", label: "Live markets", detail: "complex environments" },
  { value: "System", label: "built products", detail: "from the group companies" },
]

export function ProductsSignalSection() {
  return (
