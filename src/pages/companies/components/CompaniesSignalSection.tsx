const signals = [
  { value: "06", label: "Specialist companies", detail: "distinct disciplines" },
  { value: "01", label: "Integrated system", detail: "shared operating model" },
  { value: "Independent", label: "or together", detail: "as the work requires" },
  { value: "Kampala", label: "Operating base", detail: "built for complex markets" },
]

export function CompaniesSignalSection() {
  return (
