...
import heroAtmosphere from "../../../assets/home/product-img.png"
...
export function CompaniesHeroSection() {
  return (
    <section className="relative isolate min-h-[608px] overflow-hidden border-b border-black/10 bg-[#f8f2e9] pt-[88px] md:min-h-[640px]">
      <img
        src={heroAtmosphere}
        alt="ANTIKRA companies operating environment"
        className="absolute inset-x-0 top-[88px] -z-20 h-[calc(100%-88px)] w-full object-cover object-[42%_48%]"
      />
      <div className="absolute inset-x-0 bottom-0 top-[88px] -z-10 hidden bg-[linear-gradient(90deg,#f8f2e9_0%,rgba(248,242,233,0.97)_24%,rgba(248,242,233,0.72)_38%,rgba(248,242,233,0.28)_54%,rgba(248,242,233,0)_72%)] md:block" />
      ...
      <div className="mx-auto flex min-h-[520px] w-full max-w-[1500px] items-center px-8 py-14 md:min-h-[552px] md:px-12 xl:px-[72px]">
        <div className="w-full max-w-[560px]">
          ...
          <h1 className="mt-5 font-display text-[3.6rem] font-semibold leading-[0.94] tracking-[-0.035em] text-[#16110f] md:text-[4.6rem] xl:text-[5.4rem]">
            Six specialists.
            <br />
            One operating
            <br />
          ...
          <p className="mt-5 max-w-[420px] text-[0.9rem] leading-[1.58] text-[#1d1d1d]/70 md:text-[0.95rem]">
            Each ANTIKRA company owns a discipline. Together they form a system
            that can build products, run infrastructure, and create companies.
          </p>
