const signals = [
  ...
  { value: "Multi", label: "company delivery", detail: "assembled as needed" },
  { value: "End-to-end", label: "engagements", detail: "from understand to evolve" },
  { value: "Real", label: "operating contexts", detail: "not slideware solutions" },
]

export function SolutionsSignalSection() {
  return (
      ...
      <div className="mx-auto grid w-full max-w-[1500px] px-8 py-11 md:grid-cols-4 md:px-12 xl:px-[72px]">
        {signals.map((signal, index) => (
          ...
          >
            ...
            <p className="font-display text-[2rem] font-semibold leading-none tracking-[0.02em] text-[#a97b32] md:text-[2.25rem]">
              {signal.value}
            </p>
